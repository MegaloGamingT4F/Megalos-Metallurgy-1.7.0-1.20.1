...
public class ModTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MEGALOS_METALLURGY_TAB = CREATIVE_MODE_TABS.register("metallurgy_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.ALUMINIUM_ORE.get()))
                    .title(Component.translatable("itemGroup.megalosmetallurgy.metallurgy_tab"))
                    .displayItems((displayParams, output) -> {
                        output.accept(ModBlocks.ALUMINIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_ANTIMONY_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_ARSENIC_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_BARIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_BERYLLIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_BISMUTH_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_CADMIUM_ORE.get());
                        output.accept(ModBlocks.CALCIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_CAESIUM_ORE.get());
                        ...
                        output.accept(ModBlocks.NETHERRACK_GERMANIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_GALLIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_HAFNIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_INDIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_IRIDIUM_ORE.get());
                        output.accept(ModBlocks.LEAD_ORE.get());
                        output.accept(ModBlocks.END_STONE_LITHIUM_ORE.get());
                        output.accept(ModBlocks.MAGNESIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_MANGANESE_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_MOLYBDENUM_ORE.get());
                        output.accept(ModBlocks.NICKEL_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_NIOBIUM_ORE.get());
                        output.accept(ModBlocks.OSMIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_PALLADIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_PHOSPHORUS_ORE.get());
                        output.accept(ModBlocks.PLATINUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_POTASSIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_RHENIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_RHODIUM_ORE.get());
                        output.accept(ModBlocks.END_STONE_RUBIDIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_RUTHENIUM_ORE.get());
                        output.accept(ModBlocks.END_STONE_SCANDIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_SELENIUM_ORE.get());
                        output.accept(ModBlocks.SILICON_ORE.get());
                        output.accept(ModBlocks.SILVER_ORE.get());
                        output.accept(ModBlocks.SODIUM_ORE.get());
                        output.accept(ModBlocks.END_STONE_STRONTIUM_ORE.get());
                        output.accept(ModBlocks.END_STONE_TANTALUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_TECHNETIUM_ORE.get());
                        output.accept(ModBlocks.NETHERRACK_TELLURIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_THALLIUM_ORE.get());
                        output.accept(ModBlocks.TIN_ORE.get());
                        output.accept(ModBlocks.TITANIUM_ORE.get());
                        output.accept(ModBlocks.DEEPSLATE_TUNGSTEN_ORE.get());
                        output.accept(ModBlocks.END_STONE_VANADIUM_ORE.get());
                        output.accept(ModBlocks.END_STONE_YTTRIUM_ORE.get());
    ...
    public static final RegistryObject<CreativeModeTab> MEGALOS_METALLURGY_HOPLOLOGY_TAB = CREATIVE_MODE_TABS.register("hoplology_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.ALUMINIUM_SWORD.get()))
                    .title(Component.translatable("itemGroup.megalosmetallurgy.hoplology_tab"))
                    .displayItems((displayParams, output) -> {
