package io.github.megalogaming_uk.megalosmetallurgy.init;

import io.github.megalogaming_uk.megalosmetallurgy.MegalosMetallurgy;
import io.github.megalogaming_uk.megalosmetallurgy.init.tiers.ModToolTiers;
...
//Block Items - Ore
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
        pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.aluminium_ore.tooltip"));
        super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
    }});
    public static final RegistryObject<BlockItem> ANTIMONY_ORE_ITEM = ITEMS.register("antimony_ore",() -> new BlockItem(ModBlocks.ANTIMONY_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.antimony_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> ARSENIC_ORE_ITEM = ITEMS.register("arsenic_ore",() -> new BlockItem(ModBlocks.ARSENIC_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
        pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.arsenic_ore.tooltip"));
        super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
    }});
    public static final RegistryObject<BlockItem> BARIUM_ORE_ITEM = ITEMS.register("barium_ore",() -> new BlockItem(ModBlocks.BARIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.barium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> BERYLLIUM_ORE_ITEM = ITEMS.register("beryllium_ore",() -> new BlockItem(ModBlocks.BERYLLIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.beryllium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> BISMUTH_ORE_ITEM = ITEMS.register("bismuth_ore",() -> new BlockItem(ModBlocks.BISMUTH_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.bismuth_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> CADMIUM_ORE_ITEM = ITEMS.register("cadmium_ore",() -> new BlockItem(ModBlocks.CADMIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.cadmium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> CAESIUM_ORE_ITEM = ITEMS.register("caesium_ore",() -> new BlockItem(ModBlocks.CAESIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.caesium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> CALCIUM_ORE_ITEM = ITEMS.register("calcium_ore",() -> new BlockItem(ModBlocks.CALCIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.calcium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> CHROMIUM_ORE_ITEM = ITEMS.register("chromium_ore",() -> new BlockItem(ModBlocks.CHROMIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.chromium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> CINNABAR_ORE_ITEM = ITEMS.register("cinnabar_ore",() -> new BlockItem(ModBlocks.CINNABAR_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.cinnabar_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> COBALT_ORE_ITEM = ITEMS.register("cobalt_ore",() -> new BlockItem(ModBlocks.COBALT_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.cobalt_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> GERMANIUM_ORE_ITEM = ITEMS.register("germanium_ore",() -> new BlockItem(ModBlocks.GERMANIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.gallium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> GALLIUM_ORE_ITEM = ITEMS.register("gallium_ore",() -> new BlockItem(ModBlocks.GALLIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.germanium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> HAFNIUM_ORE_ITEM = ITEMS.register("hafnium_ore",() -> new BlockItem(ModBlocks.HAFNIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.hafnium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> INDIUM_ORE_ITEM = ITEMS.register("indium_ore",() -> new BlockItem(ModBlocks.INDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.indium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> IRIDIUM_ORE_ITEM = ITEMS.register("iridium_ore",() -> new BlockItem(ModBlocks.IRIDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.iridium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> LEAD_ORE_ITEM = ITEMS.register("lead_ore",() -> new BlockItem(ModBlocks.LEAD_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.lead_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> LITHIUM_ORE_ITEM = ITEMS.register("lithium_ore",() -> new BlockItem(ModBlocks.LITHIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.lithium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> MAGNESIUM_ORE_ITEM = ITEMS.register("magnesium_ore",() -> new BlockItem(ModBlocks.MAGNESIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.magnesium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> MANGANESE_ORE_ITEM = ITEMS.register("manganese_ore",() -> new BlockItem(ModBlocks.MANGANESE_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.manganese_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> MOLYBDENUM_ORE_ITEM = ITEMS.register("molybdenum_ore",() -> new BlockItem(ModBlocks.MOLYBDENUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.molybdenum_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> NICKEL_ORE_ITEM = ITEMS.register("nickel_ore",() -> new BlockItem(ModBlocks.NICKEL_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.nickel_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> NIOBIUM_ORE_ITEM = ITEMS.register("niobium_ore",() -> new BlockItem(ModBlocks.NIOBIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.niobium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> OSMIUM_ORE_ITEM = ITEMS.register("osmium_ore",() -> new BlockItem(ModBlocks.OSMIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.osmium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> PALLADIUM_ORE_ITEM = ITEMS.register("palladium_ore",() -> new BlockItem(ModBlocks.PALLADIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.palladium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> PHOSPHORUS_ORE_ITEM = ITEMS.register("phosphorus_ore",() -> new BlockItem(ModBlocks.PHOSPHORUS_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.phosphorus_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> PLATINUM_ORE_ITEM = ITEMS.register("platinum_ore",() -> new BlockItem(ModBlocks.PLATINUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.platinum_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> POTASSIUM_ORE_ITEM = ITEMS.register("potassium_ore",() -> new BlockItem(ModBlocks.POTASSIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.potassium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> RHENIUM_ORE_ITEM = ITEMS.register("rhenium_ore",() -> new BlockItem(ModBlocks.RHENIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.rhenium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> RHODIUM_ORE_ITEM = ITEMS.register("rhodium_ore",() -> new BlockItem(ModBlocks.RHODIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.rhodium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> RUBIDIUM_ORE_ITEM = ITEMS.register("rubidium_ore",() -> new BlockItem(ModBlocks.RUBIDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.rubidium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> RUTHENIUM_ORE_ITEM = ITEMS.register("ruthenium_ore",() -> new BlockItem(ModBlocks.RUTHENIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.ruthenium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> SCANDIUM_ORE_ITEM = ITEMS.register("scandium_ore",() -> new BlockItem(ModBlocks.SCANDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.scandium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> SELENIUM_ORE_ITEM = ITEMS.register("selenium_ore",() -> new BlockItem(ModBlocks.SELENIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.selenium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> SILICON_ORE_ITEM = ITEMS.register("silicon_ore",() -> new BlockItem(ModBlocks.SILICON_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.silicon_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> SILVER_ORE_ITEM = ITEMS.register("silver_ore",() -> new BlockItem(ModBlocks.SILVER_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.silver_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> SODIUM_ORE_ITEM = ITEMS.register("sodium_ore",() -> new BlockItem(ModBlocks.SODIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.sodium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> STRONTIUM_ORE_ITEM = ITEMS.register("strontium_ore",() -> new BlockItem(ModBlocks.STRONTIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.strontium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TANTALUM_ORE_ITEM = ITEMS.register("tantalum_ore",() -> new BlockItem(ModBlocks.TANTALUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.tantalum.ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TECHNETIUM_ORE_ITEM = ITEMS.register("technetium_ore",() -> new BlockItem(ModBlocks.TECHNETIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.technetium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TELLURIUM_ORE_ITEM = ITEMS.register("tellurium_ore",() -> new BlockItem(ModBlocks.TELLURIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.tellurium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> THALLIUM_ORE_ITEM = ITEMS.register("thallium_ore",() -> new BlockItem(ModBlocks.THALLIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.thallium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TIN_ORE_ITEM = ITEMS.register("tin_ore",() -> new BlockItem(ModBlocks.TIN_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.tin_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TITANIUM_ORE_ITEM = ITEMS.register("titanium_ore",() -> new BlockItem(ModBlocks.TITANIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.titanium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> TUNGSTEN_ORE_ITEM = ITEMS.register("tungsten_ore",() -> new BlockItem(ModBlocks.TUNGSTEN_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.tungsten_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> VANADIUM_ORE_ITEM = ITEMS.register("vanadium_ore",() -> new BlockItem(ModBlocks.VANADIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.vanadium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> YTTRIUM_ORE_ITEM = ITEMS.register("yttrium_ore",() -> new BlockItem(ModBlocks.YTTRIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.yttrium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> ZINC_ORE_ITEM = ITEMS.register("zinc_ore",() -> new BlockItem(ModBlocks.ZINC_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.zinc_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
    public static final RegistryObject<BlockItem> ZIRCONIUM_ORE_ITEM = ITEMS.register("zirconium_ore",() -> new BlockItem(ModBlocks.ZIRCONIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)){
        @Override
        public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced){
            pTooltipComponents.add(Component.translatable("tooltip.megalosmetallurgy.zirconium_ore.tooltip"));
            super.appendHoverText(pStack, pLevel, pTooltipComponents, pIsAdvanced);
        }});
...
//Tools
    // Aluminium Tools
    public static final RegistryObject<SwordItem> ALUMINIUM_SWORD = ITEMS.register("aluminium_sword", () -> new SwordItem(ModToolTiers.ALUMINIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<PickaxeItem> ALUMINIUM_PICKAXE = ITEMS.register("aluminium_pickaxe", () -> new PickaxeItem(ModToolTiers.ALUMINIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<ShovelItem> ALUMINIUM_SHOVEL = ITEMS.register("aluminium_shovel", () -> new ShovelItem(ModToolTiers.ALUMINIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<AxeItem> ALUMINIUM_AXE = ITEMS.register("aluminium_axe", () -> new AxeItem(ModToolTiers.ALUMINIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<HoeItem> ALUMINIUM_HOE = ITEMS.register("aluminium_hoe", () -> new HoeItem(ModToolTiers.ALUMINIUM,7,2.5f,new Item.Properties()));

    //Titanium Tools
    public static final RegistryObject<SwordItem> TITANIUM_SWORD = ITEMS.register("titanium_sword", () -> new SwordItem(ModToolTiers.TITANIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<PickaxeItem> TITANIUM_PICKAXE = ITEMS.register("titanium_pickaxe", () -> new PickaxeItem(ModToolTiers.TITANIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<ShovelItem> TITANIUM_SHOVEL = ITEMS.register("titanium_shovel", () -> new ShovelItem(ModToolTiers.TITANIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<AxeItem> TITANIUM_AXE = ITEMS.register("titanium_axe", () -> new AxeItem(ModToolTiers.TITANIUM,7,2.5f,new Item.Properties()));
    public static final RegistryObject<HoeItem> TITANIUM_HOE = ITEMS.register("titanium_hoe", () -> new HoeItem(ModToolTiers.TITANIUM,7,2.5f,new Item.Properties()));

    //Silver Tools
    public static final RegistryObject<SwordItem> SILVER_SWORD = ITEMS.register("silver_sword", () -> new SwordItem(ModToolTiers.SILVER,7,2.5f,new Item.Properties()));
    public static final RegistryObject<PickaxeItem> SILVER_PICKAXE = ITEMS.register("silver_pickaxe", () -> new PickaxeItem(ModToolTiers.SILVER,7,2.5f,new Item.Properties()));
    public static final RegistryObject<ShovelItem> SILVER_SHOVEL = ITEMS.register("silver_shovel", () -> new ShovelItem(ModToolTiers.SILVER,7,2.5f,new Item.Properties()));
    public static final RegistryObject<AxeItem> SILVER_AXE = ITEMS.register("silver_axe", () -> new AxeItem(ModToolTiers.SILVER,7,2.5f,new Item.Properties()));
    public static final RegistryObject<HoeItem> SILVER_HOE = ITEMS.register("silver_hoe", () -> new HoeItem(ModToolTiers.SILVER,7,2.5f,new Item.Properties()));
